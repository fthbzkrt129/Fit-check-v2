...
import type { ExperimentalGarmentSelection, GarmentCategory, StylingMode, WardrobeItem } from '@/lib/kombin/types';
import { UploadCloudIcon, CheckCircleIcon, PinIcon } from './icons';
import { formatWardrobeItemName } from '@/lib/kombin/wardrobeItemName';
    ...
    <div className="pt-6 border-t border-gray-400/50">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 sm:gap-3">
            ...
            return (
                ...
                {item.isPinned && (
                    <div className="absolute right-2 top-2 inline-flex items-center gap-1 rounded-full bg-gray-900/85 px-2 py-1 text-[10px] font-semibold text-white shadow-sm">
        ...
        {visibleWardrobe.length === 0 && (
             <p className="text-center text-sm text-gray-500 mt-4">Bu adım için uygun ürün henüz yok. Yüklediğiniz ürünler burada görünecek.</p>
        )}
